...
const TechInfluencer = forwardRef(
  ({ onClick, onBringToFront, heroZIndex }, ref) => {
    ...
    return (
      <div
        ...
        className="absolute top-0 left-0 w-68 h-46 rounded-xl flex flex-col items-center justify-center cursor-grab active:cursor-grabbing select-none"
      >
        <div className="w-full flex justify-center -mt-1">
          <img
            className="w-65 rounded-2xl mt-2 shadow-[0_2px_7px_rgba(0,0,0,0.25)] object-cover pointer-events-none"
            src="../assets/heroSectionPics/CodingStar.jpeg"
            alt="Tech Influencer"
            draggable={false}
          />
        </div>
        ...
        <div className="pt-1 pointer-events-none">
          <h1
            ref={textRef}
            className="text-center py-1 flex items-center justify-center text-xs h-5 w-30 rounded-md text-white font-medium [text-shadow:0_0_4px_rgba(0,0,0,0.8)]"
          >
            Tech Influencer
          </h1>
        </div>
