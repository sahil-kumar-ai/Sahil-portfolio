...
const ContentCreator = forwardRef(
  ({ onClick, onBringToFront, heroZIndex }, ref) => {
    ...
    return (
      <div
        ...
        className="absolute top-0 left-0 w-69 h-58 rounded-2xl flex flex-col items-center justify-center cursor-grab active:cursor-grabbing select-none"
      >
        <div className="w-full flex justify-center -translate-y-1.25">
          <img
            className="w-65 rounded-2xl mt-2 shadow-[0_2px_7px_rgba(0,0,0,0.25)] pointer-events-none"
            src="../assets/heroSectionPics/youtube.png"
            alt="YouTube"
            draggable={false}
          />
        </div>
        ...
        <div className="pt-1 pointer-events-none">
          <h1
            ref={textRef}
            className="text-center py-1 flex flex-col items-center justify-center text-xs h-6 w-23 -translate-y-1 rounded-md text-white font-medium [text-shadow:0_0_4px_rgba(0,0,0,0.8)]"
          >
            Content Creator
          </h1>
        </div>
