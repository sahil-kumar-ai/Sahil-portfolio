      ...
      >
        <div className="w-full flex justify-center -mt-1">
          <video
            ...
            src="../assets/heroSectionPics/Hobbies.mp4"
            muted
            autoPlay
            loop
            playsInline
        ...
        <div className="pt-1 pointer-events-none">
          <h1
            ref={textRef}
            className="text-center py-1 flex flex-col items-center justify-center text-xs h-5 w-25 rounded-md text-white font-medium [text-shadow:0_0_4px_rgba(0,0,0,0.8)]"
          >
            Hobbies
          </h1>
        </div>
